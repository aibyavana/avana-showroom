...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "AVANA Showroom" },
      ...
      { name: "twitter:site", content: "@avanashowroom" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Archivo:wght@700;800&display=swap" },
